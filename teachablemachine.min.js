                        ...
                        if (e.indexOf(r) >= 0) {
                            ...
                            for (let e = 0; e < a; e++) {
                                ...
                                if ("" === i)
                                    ...
                                    const t = h.exec(i);
                                    null !== t && c(t[2], s) && (i = i.slice(0, t.index) + t[1] + t[2].slice(0, -s.length) + t[3]),
...
, function(t, e, n) {
    ...
    var r = n(11)
      ...
      , a = n(13)
      , c = n(0);
    const l = t=>null === t || !("object" == typeof t || "function" == typeof t)
    ...
    class p {
        ...
        setValue(t) {
            t === i.a || l(t) && t === this.value || (this.value = t,
    ...
    class d {
        ...
        commit() {
            ...
            const t = this.__pendingValue;
            t !== i.a && (l(t) ? t !== this.value && this.__commitText(t) : t instanceof a.b ? this.__commitTemplateResult(t) : t instanceof Node ? this.__commitNode(t) : u(t) ? this.__commitIterable(t) : t === i.b ? (this.value = i.b,
...
, function(t, e, n) {
    ...
    e.squeezeShape = function(t, e) {
        for (var n = [], r = [], o = null != e && Array.isArray(e) && 0 === e.length, i = null == e || o ? null : l(e, t).sort(), s = 0, a = 0; a < t.length; ++a) {
            if (null != i) {
                ...
                (null == i[s] || i[s] > a) && 1 === t[a] && (n.push(t[a]),
                r.push(a)),
                i[s] <= a && s++
            }
            1 !== t[a] && (n.push(t[a]),
    ...
    e.makeOnesTypedArray = function(t, e) {
        for (var n = y(t, e), r = 0; r < n.length; r++)
            n[r] = 1;
        return n
    }
    ,
...
, function(t, e, n) {
    ...
    function s(t, e) {
        ...
        for (; o.nextNode(); ) {
            ...
            e.has(t) && (u.push(t),
            null === h && (h = t)),
            null !== h && l++; void 0 !== s && s.index === a; )
                s.index = null !== h ? -1 : s.index - l,
                i = c(r, i),
                s = r[i]
        }
    ...
    const p = (t,e)=>`${t}--${e}`;
    let d = !0;
    void 0 === window.ShadyCSS ? d = !1 : void 0 === window.ShadyCSS.prepareTemplateDom && (console.warn("Incompatible ShadyCSS version detected. Please update to at least @webcomponents/webcomponentsjs@2.0.2 and @webcomponents/shadycss@1.3.1."),
    d = !1);
    const f = t=>e=>{
        const n = p(e.type, t);
        let r = u.a.get(n);
        ...
        return r.stringsArray.set(e.strings, o),
        o
    }
      , y = ["html", "svg"]
      , m = new Set
      , g = (t,e,n)=>{
        ...
        n ? function(t, e, n=null) {
            ...
            for (; i.nextNode(); ) {
                for (u++,
                i.currentNode === n && (l = a(e),
                n.parentNode.insertBefore(e, n)); -1 !== s && o[s].index === u; ) {
                    if (l > 0) {
                        for (; -1 !== s; )
                            o[s].index += l,
                            s = c(o, s);
        ...
        }(n, l, h.firstChild) : h.insertBefore(l, h.firstChild),
    ...
    class x extends HTMLElement {
        ...
        static get observedAttributes() {
            ...
            return this._classProperties.forEach((e,n)=>{
                ...
                void 0 !== r && (this._attributeToPropertyMap.set(r, n),
                t.push(r))
            }
            ),
            t
        ...
        _requestUpdate(t, e) {
            ...
            if (void 0 !== t) {
                ...
                r._valueHasChanged(this[t], e, o.hasChanged) ? (this._changedProperties.has(t) || this._changedProperties.set(t, e),
                !0 !== o.reflect || 16 & this._updateState || (void 0 === this._reflectingProperties && (this._reflectingProperties = new Map),
                this._reflectingProperties.set(t, o))) : n = !1
            }
    ...
    x.finalized = !0;
    const S = t=>e=>"function" == typeof e ? ((t,e)=>(window.customElements.define(t, e),
    e))(t, e) : ((t,e)=>{
      ...
      , E = (t,e)=>"method" !== e.kind || !e.descriptor || "value"in e.descriptor ? {
        kind: "field",
        key: Symbol(),
        placement: "own",
        descriptor: {},
    ...
    const A = (t,e,n)=>{
      ...
      , R = "adoptedStyleSheets"in Document.prototype && "replace"in CSSStyleSheet.prototype
      , D = Symbol();
    class O {
        constructor(t, e) {
            if (e !== D)
        ...
        get styleSheet() {
            return void 0 === this._styleSheet && (R ? (this._styleSheet = new CSSStyleSheet,
    ...
    class N extends x {
        ...
        update(t) {
            super.update(t);
            const e = this.render();
            e instanceof r.TemplateResult && this.constructor.render(e, this.renderRoot, {
    ...
    N.render = (t,e,n)=>{
        ...
        if (Object(l.b)(t, c, Object.assign({
            templateFactory: f(r)
        }, n)),
        a) {
            const t = l.a.get(c);
...
, function(t, e, n) {
    ...
    function o(t, e, n) {
        ...
        if ("function" != typeof o)
            throw new TypeError("@boundMethod decorator can only be applied to methods not: ".concat(r(o)));
        var i = !1;
        return {
            configurable: !0,
            get: function() {
                if (i || this === t.prototype || this.hasOwnProperty(e) || "function" != typeof o)
                    return o;
                var n = o.bind(this);
                return i = !0,
...
, function(t, e, n) {
    ...
    var r = function() {
        ...
        t.prototype.get = function(t) {
            return t in this.flags ? this.flags[t] : (this.flags[t] = this.evaluateFlag(t),
            this.flags[t])
        }
        ,
...
, function(t, e, n) {
    ...
    const s = new WeakMap
      , a = (t,e,n)=>{
        let a = s.get(e);
        void 0 === a && (Object(r.b)(e, e.firstChild),
        s.set(e, a = new o.e(Object.assign({
            templateFactory: i.b
        }, n))),
        a.appendInto(e)),
        a.setValue(t),
...
, function(t, e, n) {
    ...
    class i {
        ...
        _clone() {
            const t = r.a ? this.template.element.content.cloneNode(!0) : document.importNode(this.template.element.content, !0)
              , e = []
            ...
            for (; a < n.length; )
                ...
                Object(o.d)(s)) {
                    for (; c < s.index; )
                        ...
                        null === (l = i.nextNode()) && (i.currentNode = e.pop(),
                        l = i.nextNode());
                    if ("node" === s.type) {
                    ...
                    a++;
            return r.a && (document.adoptNode(t),
...
, function(t, e, n) {
    ...
    (function(t) {
            ...
            return r(this, void 0, void 0, (function() {
                ...
                return o(this, (function(h) {
                    ...
                    case 0:
                        for (n = [],
                        i = [],
                        s = Array.isArray(t) ? t.map((function(t) {
                            return t.name
                        }
                        )) : Object.keys(t),
                        a = function(a) {
                            ...
                            if ("float32" !== l.dtype && "int32" !== l.dtype && "bool" !== l.dtype && "string" !== l.dtype)
                                throw new Error("Unsupported dtype in weight '" + c + "': " + l.dtype);
                            var h = {
                                name: c,
                                shape: l.shape,
                                dtype: l.dtype
                                    ...
                                    return r(u, void 0, void 0, (function() {
                                        ...
                                        return o(this, (function(o) {
                                            ...
                                            case 1:
                                                ...
                                                s = 0; s < e.length; s++)
                                                    a = e[s],
                                                    c = new Uint8Array(new Uint32Array([a.length]).buffer),
                                                    r.set(c, i),
                                                    i += 4,
                                                    r.set(a, i),
                                                    i += a.length;
            ...
            for (var n = {}, r = 0, o = function(e) {
                ...
                if ("quantization"in e) {
                    ...
                    if ("uint8" !== p.dtype && "uint16" !== p.dtype)
                        throw new Error("Weight " + e.name + " has unknown quantization dtype " + p.dtype + ". Supported quantization dtypes are: 'uint8' and 'uint16'.");
                    var d = a.DTYPE_VALUE_SIZE_MAP[p.dtype]
                      , f = t.slice(r, r + u * d)
                      , y = "uint8" === p.dtype ? new Uint8Array(f) : new Uint16Array(f);
                    if ("float32" === c)
                        ...
                        if ("int32" !== c)
                            throw new Error("Unsupported dtype in weight '" + o + "': " + c);
        ...
        e.base64StringToArrayBuffer = function(e) {
            ...
            for (var r = atob(e), o = new Uint8Array(r.length), i = 0; i < r.length; ++i)
        ...
        e.getModelArtifactsInfoForJSON = function(t) {
            ...
            return {
                ...
                modelTopologyBytes: null == t.modelTopology ? 0 : u(JSON.stringify(t.modelTopology)),
                weightSpecsBytes: null == t.weightSpecs ? 0 : u(JSON.stringify(t.weightSpecs)),
...
, function(t, e, n) {
    ...
    let d = r = class extends s.WebcamElement {
        constructor() {
            ...
            this.tapMediaStream = (t,e,n,r)=>{
                if (s.defaultTapMediaStream(t, e, n, r),
        ...
        update(t) {
            if (t.has("edit") && this.video && this.sourceCtx && !this.firstUpdate) {
                ...
                this.edit ? (this.scaledVideoWidth = this.width,
                this.scaledVideoHeight = n / e * this.width,
                t.style.height = `${this.scaledVideoHeight}px`,
                this.dispatchEvent(new CustomEvent("beginCrop"))) : (this.scaledVideoWidth = this.width,
        ...
        __handleCropPanStart(t) {
            ...
            const e = [this.cropLeft, this.cropTop]
              ...
              , s = t=>{
                ...
                this.cropTop + this.cropHeight <= this.scaledVideoHeight && (this.cropLeft = u.clamp(i[0], 0, this.scaledVideoWidth - this.cropWidth),
                this.cropTop = u.clamp(i[1], 0, this.scaledVideoHeight - this.cropHeight))
            }
              , a = ()=>{
                this.__isScalingCrop = !1,
            ...
            const a = l.mousePositionFromEvent(t, this)
              ...
              , h = t=>{
                ...
                case "crop-br-grabber":
                    ...
                    break;
                case "crop-tr-grabber":
                    m && f && (this.cropWidth = this.cropHeight = h,
                    this.cropTop = d - h);
                    break;
                case "crop-bl-grabber":
                    g && y && (this.cropWidth = this.cropHeight = h,
                    this.cropLeft = p - h);
                    break;
                case "crop-tl-grabber":
                    y && f && (this.cropWidth = this.cropHeight = h,
                    this.cropLeft = p - h,
                    this.cropTop = d - h)
                }
            }
        ...
        __toggleCrop() {
            if (!this.video || !this.sourceCtx || this.firstUpdate)
                return;
            Array.from(this.shadowRoot.querySelectorAll(".webcam-button")).forEach(t=>t.blur()),
            this.edit = !this.edit
        }
        render() {
            const t = this.width
        ...
        _renderCameraToSourceCanvas() {
            ...
            let r;
            this.firstUpdate && (this.cropWidth = this.cropHeight = e / t * this.height,
            this.cropLeft = (this.width - this.cropWidth) / 2,
            this.firstUpdate = !1),
            r = this.isFlipped() ? t - this.cropLeft * n - this.cropWidth * n : this.cropLeft * n;
    ...
    o([i.property({
        type: Boolean,
        reflect: !0
    })], d.prototype, "edit", void 0),
    o([i.property({
        type: Number,
        reflect: !0
    })], d.prototype, "cropLeft", void 0),
    o([i.property({
        type: Number
    })], d.prototype, "cropTop", void 0),
    o([i.property({
        type: Number
    })], d.prototype, "cropWidth", void 0),
    o([i.property({
        type: Number
    })], d.prototype, "cropHeight", void 0),
    o([i.property({
        type: Number
    })], d.prototype, "minCropWidth", void 0),
    o([i.property({
        type: Number
    })], d.prototype, "minCropHeight", void 0),
    o([i.property({
        type: Number
    })], d.prototype, "scaledVideoWidth", void 0),
    o([i.property({
        type: Number
    })], d.prototype, "scaledVideoHeight", void 0),
    o([i.property({
        type: Number
    })], d.prototype, "aspect", void 0),
    o([i.property({
        type: Boolean,
        reflect: !0
    })], d.prototype, "paused", void 0),
...
, function(t, e, n) {
    ...
    (function(t, r) {
        ...
        var s, a = n(9), c = n(94), l = n(95), u = n(96), h = n(30), p = n(98), d = n(2), f = n(2), y = function() {
                ...
                get: function() {
                    ...
                    if (null == this.backendInstance) {
                        var t = this.initializeBackendsAndReturnBest()
                          , e = t.name;
                        if (t.asyncInit)
                            throw new Error("The highest priority backend '" + e + "' has not yet been initialized. Make sure to await tf.ready() before calling other methods");
                        this.setBackend(e)
                    }
            ...
            t.prototype.checkKernelForMemLeak = function(t, e, n) {
                ...
                var i = this.state.numDataMovesStack[this.state.numDataMovesStack.length - 1]
                  , s = r - e - o - i;
                if (s > 0)
                    throw new Error("Backend '" + this.backendName + "' has an internal memory leak (" + s + " data ids) after running '" + t + "'")
            }
            ,
            t.prototype.runKernelFunc = function(t, e, n, r, o, i, s) {
                ...
                : function() {
                    ...
                    var n = Array.isArray(g) ? g : [g];
                    return l.shouldCheckForMemLeaks() && l.checkKernelForMemLeak(d, e, n),
                    n
                }
                ,
            ...
            t.prototype.incRef = function(t, e) {
                ...
                0 === n) {
                    ...
                    var r = 0;
                    "complex64" !== t.dtype && "string" !== t.dtype && (r = t.size * d.bytesPerElement(t.dtype)),
            ...
            t.prototype.gradients = function(t, n, r, o) {
                ...
                return this.tidy("backward", (function() {
                    var t, o, c = {};
                    c[s.id] = null == r ? (t = s.shape,
                    o = f.makeOnesTypedArray(f.sizeFromShape(t), "float32"),
                    e.ENGINE.makeTensor(o, t, "float32")) : r,
            ...
            t.prototype.customGrad = function(t) {
                ...
                function() {
                    ...
                    e.runKernelFunc((function(e, o) {
                        return n = t.apply(void 0, r.concat([o])),
            ...
            t.prototype.time = function(t) {
                return o(this, void 0, void 0, (function() {
                    ...
                    return i(this, (function(r) {
                        ...
                        case 1:
                            return (n = r.sent()).wallMs = f.now() - e,
                            [2, n]
                        }
                    }
                    ))
        ...
        e.ENGINE = function() {
            ...
            return a.setEnvironmentGlobal(e._tfengine.ENV),
...
, function(t, e, n) {
    ...
    var l = function(t) {
        function e(e) {
            ...
            n.setFPS(e.fps || 1 / 0),
            n.setRequestAnimationFrameObject(e.requestAnimationFrameObject || a),
            n
        }
        return o(e, t),
        ...
        e.prototype.setRequestAnimationFrameObject = function(t) {
            if ("function" != typeof t.requestAnimationFrame || "function" != typeof t.cancelAnimationFrame)
                throw new Error("Invalid object provide to `setRequestAnimationFrameObject`");
            return this.__requestAnimationFrameObject = t,
            this
        }
        ,
              ...
              , n = function() {
                ...
                var r = t.__requestAnimationFrameObject
                  , o = function() {
                    ...
                    if (r !== e)
                        return r = e,
                        void e.requestAnimationFrame(o);
                    t.__isReadyForUpdate() && t.update(),
                    t.__running ? n = e.requestAnimationFrame(o) : e.cancelAnimationFrame(n)
                };
                return t.getRequestAnimationFrameObject().requestAnimationFrame(o),
                t
            };
            return this.__delay ? setTimeout(n, this.__delay) : n(),
            this
        }
        ,
        e.prototype.stop = function() {
            return this.__running && (this.__running = !1,
            e.instancesRunning -= 1,
        ...
        e.prototype.update = function() {
            this.frameCount++;
            var t = Date.now();
            return this.__lastTime = this.__lastTime || t,
            this.deltaTime = this.fixedDelta || e.globalFixedDelta ? 1e3 / Math.min(60, this.__fps) : t - this.__lastTime,
    ...
    function h(t, e) {
        1 === arguments.length && u(t) && (e = t,
        t = {});
        var n = new l(t);
        return e && n.on("update", e),
        n
    }
    function p(t, e) {
    ...
    h.bound = function(t, e) {
        for (var n, r = h(t, e), o = function(t) {
            ...
            return n
        }(l.prototype), i = !!Function.prototype.bind, s = 0; s < o.length; s++)
...
, function(t, e, n) {
    ...
    let h = r = class extends l.AbstractSampleInputElement {
        constructor() {
            ...
            this.buttonSVG = "M18 6V10.48L22 6.5V17.5L18 13.52V14.52V18C18 19.1 17.1 20 16 20H4C2.9 20 2 19.1 2 18V6C2 4.9 2.9 4 4 4H16C17.1 4 18 4.9 18 6ZM16 14.52V9.69V6H4V18H16V14.52Z",
        ...
        set _shouldAddFrame(t) {
            t !== this._shouldAddFrame && (this.___isAddingFrames = t,
        ...
        beginCapture() {
            return this._shouldAddFrame = !0,
            this
        }
        endCapture() {
            return this._shouldAddFrame = !1,
            this
        }
        stop() {
            this.__webcamElement.stop(),
            this.__webcamElement.paused = !0
        }
        play(t={}) {
            void 0 === t.deviceId && r.lastDeviceId && (t.deviceId = r.lastDeviceId),
        ...
        update(t) {
            if (!this.__webcamElement)
                return super.update(t);
            if ((t.has("open") || t.has("disabled")) && (this.open && (this.autoPlay || this.autoRecord) && !this.disabled ? this.play() : this.stop()),
            !1 === t.get("settings") || !1 === t.get("open")) {
                const t = this.shadowRoot.querySelector("#fps");
                this.webcamThrottle = r.lastWebcamThrottle,
                t.value = r.lastWebcamThrottle.toString(),
                this.shadowRoot.querySelector("#hold-to-record").checked = r.lastHoldToRecord;
            ...
            return t.has("settings") && this.dispatchEvent(new CustomEvent(this.settings ? "settings" : "settingsexit",{
                bubbles: !0
            })),
            super.update(t)
        }
        ...
        __handleCrop(t) {
            this.shadowRoot.querySelector("#crop-btn").style.display = t && this.showRecord ? "block" : "none",
            this.shadowRoot.querySelector("#show-record").style.visibility = t ? "hidden" : "visible"
        }
        render() {
            const t = this;
            return s.html`
            ...
            <div id="container">
                ...
                this.shadowRoot.querySelector("#webcam").resetWebcam(),
    ...
    h.lastWebcamThrottle = null !== u.default.getWebcamSetting("webcamThrottle") ? Number(u.default.getWebcamSetting("webcamThrottle")) : 24,
    h.lastHoldToRecord = null === u.default.getWebcamSetting("holdToRecord") || u.default.getWebcamSetting("holdToRecord"),
    h.lastRecordDelay = null !== u.default.getWebcamSetting("recordDelay") ? Number(u.default.getWebcamSetting("recordDelay")) : 2e3,
    h.lastRecordDuration = null !== u.default.getWebcamSetting("recordDuration") ? Number(u.default.getWebcamSetting("recordDuration")) : 6e3,
    o([s.property({
        type: String
    })], h.prototype, "buttonLabel", void 0),
    o([s.property({
        type: String
    })], h.prototype, "buttonSVG", void 0),
    o([s.property({
        type: Number
    })], h.prototype, "webcamThrottle", void 0),
    o([s.property({
        type: Boolean
    })], h.prototype, "holdToRecord", void 0),
    o([s.property({
        type: Number
    })], h.prototype, "recordDelay", void 0),
    o([s.property({
        type: Number
    })], h.prototype, "recordDuration", void 0),
    o([s.property({
        type: Boolean,
        reflect: !0
    })], h.prototype, "autoPlay", void 0),
    o([s.property({
        type: Boolean
    })], h.prototype, "autoRecord", void 0),
    o([s.property({
        type: Boolean,
        reflect: !0
    })], h.prototype, "settings", void 0),
    o([s.property({
        type: Boolean,
        reflect: !0
    })], h.prototype, "showRecord", void 0),
...
, function(t, e, n) {
    ...
    let d = r = class extends l.AbstractUserMediaElement {
        ...
        get frameRate() {
            ...
            if (t) {
                ...
                if (e && e[0])
                    return e[0].getSettings().frameRate
            }
            return 30
        }
        ...
        get sourceCtx() {
            if (this.__sourceCtx)
                return this.__sourceCtx;
            const t = this.shadowRoot.querySelector("#source-target");
            return t ? (this.__sourceCtx = t.getContext("2d"),
            this.__sourceCtx) : null
        }
        get sourceCanvas() {
        ...
        get canvas() {
            ...
            return t ? (this._ctx = t.getContext("2d"),
        ...
        play(t) {
            return t && (this.__promiseGetWebcam = null),
            void 0 === (t = t || {}).deviceId && "string" == typeof this.deviceId && (t.deviceId = this.deviceId),
            !(t.width > 0) && this.deviceWidth > 0 && (t.width = this.deviceWidth),
            !(t.height > 0) && this.deviceHeight > 0 && (t.height = this.deviceHeight),
            this.__promiseGetWebcam && this.__promiseHasResized || (this._isInitialized = !1,
            this.__promiseHasResized = new Promise(t=>{
                const e = ()=>{
                    this.video.videoWidth * this.video.videoHeight < 4 || (this.video.removeEventListener("timeupdate", e),
            ...
            this.__promiseGetWebcam = l.getUserMedia({
                video: t
            }).catch(t=>{
                console.log(t),
                this._isOk = !1,
                this.dispatchEvent(new CustomEvent("webcamReject",{
                    bubbles: !0
                }))
            }
            ).then(t=>{
                ...
                if (!e)
                    throw new Error("No MediaStreamTrack found");
                const n = e.getConstraints();
                this.tapMediaStream(this, n, t, e),
                this.video.srcObject = t;
                const {video: r} = this;
                if (this.__curentMediaStreamTrack = e,
                this._lastMediaTrackConstraints = n,
                this.deviceId = n && "string" == typeof n.deviceId ? n.deviceId : "default",
                r)
                    return r.play().then(()=>(this._isOk = !0,
                    r.videoWidth === this.deviceWidth && r.videoHeight === this.deviceHeight || (this.deviceWidth = r.videoWidth,
                    this.deviceHeight = r.videoHeight,
                    this.__skipNextUpdatingConstraints = !0),
                    this.dispatchEvent(new CustomEvent("webcamAccept",{
                        bubbles: !0
                    })),
                    r))
            }
        ...
        _renderCameraToSourceCanvas(t=0, e=0, n=this.deviceWidth, o=this.deviceHeight, i=0, s=0, a=this.sourceCanvas.width, c=this.sourceCanvas.height) {
            ...
            r.flip ? (i = -a,
            l.scale(-1, 1),
            l.drawImage(this.video, t, e, n, o, i, s, a, c)) : l.drawImage(this.video, t, e, n, o, i, s, a, c)
        }
        update(t) {
        ...
        copySourceToCanvas(t, e=this.sourceCanvas.width, n=this.sourceCanvas.height) {
            ...
            return r !== this.sourceCtx && (r.canvas.width = e,
            r.canvas.height = n,
        ...
        _handleLoopUpdate(t, e, n) {
            return i(this, void 0, void 0, (function*() {
                if (this._isReadyForNextFrame) {
                    if (this._renderCameraToSourceCanvas(),
                    yield this.toCanvas(this.canvas, this.sourceCanvas.width, this.sourceCanvas.height),
                    this.stats) {
    ...
    o([s.property({
        type: Boolean,
        reflect: !0
    })], d.prototype, "stats", void 0),
    o([s.property({
        type: Number
    })], d.prototype, "throttle", void 0),
    o([s.property({
        type: Number,
        reflect: !0
    ...
    o([s.property({
        type: Number,
        reflect: !0
    })], d.prototype, "deviceWidth", void 0),
    o([s.property({
        type: Number,
        reflect: !0
    })], d.prototype, "deviceHeight", void 0),
    o([s.property({
        type: String
    })], d.prototype, "deviceId", void 0),
...
, function(t, e, n) {
    ...
    const o = n(24)
      , i = n(3)
      , s = n(8)
      , a = (t,e,n)=>t === -e ? `Record ${Math.floor(n / 1e3)} Seconds` : t < 0 ? `Recording in ${Math.ceil(-1 * t / 1e3)}s...` : `Recording ${Math.floor(t / 1e3)}s...`;
    let c = class extends i.LitElement {
        ...
        connectedCallback() {
            return this._delayLoop = new o.Animitter,
        ...
        disconnectedCallback() {
            return this._delayLoop.dispose(),
            this._loop.dispose(),
        ...
        _handleDelayUpdate(t, e) {
            ...
            this._updateLabel(),
            this.dispatchEvent(new CustomEvent("delayupdate",{
                bubbles: !0
            })),
            e >= this.delay && this._delayLoop.complete()
        }
        _handleDelayComplete() {
            this.dispatchEvent(new CustomEvent("delaycomplete",{
                bubbles: !0
            })),
        ...
        _updateLabel() {
            const t = this._delayLoop.elapsedTime - this.delay + this._loop.elapsedTime
        ...
        cancel() {
            return !(!this.cancelable || !this._delayLoop.isRunning() && !this._loop.isRunning()) && (this._delayLoop.stop(),
            this._delayLoop.reset(),
            this._loop.stop(),
            this._loop.reset(),
            this._updateLabel(),
        ...
        start() {
            this.cancel() || (this._resetLoops(),
            this.delay > 0 && isFinite(this.delay) ? this._delayLoop.start() : this._handleDelayComplete())
        }
        firstUpdated(t) {
            return this._fillElement = this.shadowRoot.querySelector("#fill"),
    ...
    r([i.property({
        type: Number
    })], c.prototype, "delayOnComplete", void 0),
    r([i.property({
        type: Boolean
    })], c.prototype, "cancelable", void 0),
    r([i.property({
        type: Number
    })], c.prototype, "delay", void 0),
    r([i.property({
        type: Number
    })], c.prototype, "duration", void 0),
    r([i.property({
        type: Number
    })], c.prototype, "fps", void 0),
    r([i.property({
        type: Boolean,
        reflect: !0
    })], c.prototype, "hideProgress", void 0),
    r([i.property({
        type: String
...
, function(t, e, n) {
    ...
    var f = function() {
        ...
        t.prototype.buffer = function() {
            return i(this, void 0, void 0, (function() {
                ...
                return s(this, (function(e) {
                    ...
                    case 1:
                        return t = e.sent(),
                        [2, p.buffer(this.shape, this.dtype, t)]
                    }
                }
                ))
            }
        ...
        t.prototype.array = function() {
            return i(this, void 0, void 0, (function() {
                ...
                return s(this, (function(e) {
                    ...
                    case 1:
                        return t = e.sent(),
                        [2, l.toNestedArray(this.shape, t)]
                    }
                }
                ))
            }
        ...
        t.prototype.dispose = function() {
            this.isDisposed || (h().disposeTensor(this),
        ...
        t.prototype.batchNormalization = function(t, e, n, r, o) {
            ...
            d("tf.batchNormalization() is going away. Use tf.batchNorm() instead, and note the positional argument change of scale, offset, and varianceEpsilon"),
            this.batchNorm(t, e, o, r, n)
        }
        ,
        t.prototype.batchNorm = function(t, e, n, r, o) {
            return void 0 === o && (o = .001),
            this.throwIfDisposed(),
        ...
        t.prototype.squaredDifference = function(t) {
            return this.throwIfDisposed(),
            p.squaredDifference(this, t)
        }
        ,
        t.prototype.squaredDifferenceStrict = function(t) {
            return this.throwIfDisposed(),
            p.squaredDifferenceStrict(this, t)
        }
        ,
        ...
        t.prototype.conv2dTranspose = function(t, e, n, r, o) {
            return this.throwIfDisposed(),
            p.conv2dTranspose(this, t, e, n, r, o)
        }
        ,
        ...
        t.prototype.avgPool = function(t, e, n, r) {
            return this.throwIfDisposed(),
            p.avgPool(this, t, e, n, r)
        }
        ,
        t.prototype.maxPool = function(t, e, n, r) {
            return this.throwIfDisposed(),
            p.maxPool(this, t, e, n, r)
        }
        ,
        ...
        t.prototype.unsortedSegmentSum = function(t, e) {
            return this.throwIfDisposed(),
            p.unsortedSegmentSum(this, t, e)
        }
        ,
        t.prototype.batchToSpaceND = function(t, e) {
            return this.throwIfDisposed(),
            p.batchToSpaceND(this, t, e)
        }
        ,
        t.prototype.spaceToBatchND = function(t, e) {
            return this.throwIfDisposed(),
            p.spaceToBatchND(this, t, e)
        }
        ,
        ...
        t.prototype.ifft = function() {
            return this.throwIfDisposed(),
            p.spectral.ifft(this)
        }
        ,
        t.prototype.rfft = function() {
            return this.throwIfDisposed(),
            p.spectral.rfft(this)
        }
        ,
        t.prototype.irfft = function() {
            return this.throwIfDisposed(),
            p.spectral.irfft(this)
        }
        ,
        t
    }();
...
, function(t, e, n) {
    ...
    function c(t) {
        if (-1 === t.indexOf("://"))
            throw new Error("The url string provided does not contain a scheme. Supported schemes are: " + a.getSchemes().join(","));
        return {
            scheme: t.split("://")[0],
            path: t.split("://")[1]
        }
        ...
        return r(this, void 0, void 0, (function() {
            ...
            return o(this, (function(o) {
                ...
                case 1:
                    ...
                    [4, a.getManager(i).listModels()]) : [3, 4];
                case 2:
                    for (c in s = o.sent())
                        e[i + "://" + c] = s[c];
                    o.label = 3;
    ...
    e.removeModel = function(t) {
        return r(this, void 0, void 0, (function() {
            ...
            return o(this, (function(n) {
                return e = c(t),
                [2, a.getManager(e.scheme).removeModel(e.path)]
            }
            ))
        }
        ))
...
, function(t, e, n) {
    ...
    e.cropTo = function(t, e, n=o()) {
        const r = s(t)
          ...
          , h = l - e
          , p = u - e;
        return n.width = n.height = e,
        n.getContext("2d").drawImage(t, -1 * Math.floor(h / 2), -1 * Math.floor(p / 2), l, u),
        n
    }
    ,
    ...
    e.isCanvasImageSource = t=>t && (e.isCanvas(t) || t.tagName && -1 !== ["video", "img"].indexOf(t.tagName.toLowerCase())),
    e.getContext2D = t=>e.isCanvas(t) ? t.getContext("2d") : t,
    e.toBlob = (t,e)=>r(void 0, void 0, void 0, (function*() {
...
, function(t, e, n) {
    ...
    e.getUserMedia = u,
    e.getWebcam = function(t=document.createElement("video"), n=e.defaultVideoOptions) {
        return u({
            video: n = function(t) {
                return t.facingMode = t.facingMode || e.defaultVideoOptions.facingMode,
        ...
        }).then(e=>(t.srcObject = e,
        t), ()=>Promise.reject("Could not open your camera. You may have denied access."))
    }
    ,
    e.getMicrophoneStream = function(t) {
        return u({
            ...
            video: !1
        }).then(t=>t, ()=>Promise.reject("Could not open your microphone stream. You may have denied access."))
    }
    ;
    class h extends o.LitElement {
        ...
        connectedCallback() {
            h.__instances.push(this),
            super.connectedCallback()
        }
        disconnectedCallback() {
            const t = h.__instances.indexOf(this);
            t < 0 ? console.warn("Disconnecting from dom but was never attached") : h.__instances.splice(t, 1),
            this.stop(),
            super.disconnectedCallback()
        }
        firstUpdated(t) {
        ...
        _handleLoopPlay() {
            return this.dispatchEvent(new CustomEvent("play")),
            this._loop && this._loop.stop(),
        ...
        update(t) {
            return t.get("throttle") && this._loop && this._loop.setFPS(this.throttledFrameRate),
            super.update(t)
        }
...
, function(t, e, n) {
    ...
    e.IMAGE_SIZE = 224;
    var u = function(t) {
        return t.packageVersion = t.packageVersion || l.version,
      ...
      , h = function(t, e) {
        if (1 === t) {
            if (.25 !== e && .5 !== e && .75 !== e && 1 !== e)
                return console.warn("Invalid alpha. Options are: 0.25, 0.50, 0.75 or 1.00."),
                console.log("Loading model with alpha: ", .25.toFixed(2)),
                .25
        } else if (.35 !== e && .5 !== e && .75 !== e && 1 !== e)
            return console.warn("Invalid alpha. Options are: 0.35, 0.50, 0.75 or 1.00."),
            console.log("Loading model with alpha: ", .35.toFixed(2)),
            .35;
        return e
    }
      , p = function(t) {
        ...
        t.prototype.predictTopK = function(t, n, l) {
            ...
            r(this, void 0, void 0, (function() {
                ...
                return o(this, (function(o) {
                    switch (o.label) {
                    case 0:
                        return r = c.cropTo(t, e.IMAGE_SIZE, l),
                        u = i.tidy((function() {
                            var t = a.capture(r);
        ...
        t.prototype.predict = function(t, n) {
            ...
            r(this, void 0, void 0, (function() {
                ...
                return o(this, (function(o) {
                    switch (o.label) {
                    case 0:
                        return r = c.cropTo(t, e.IMAGE_SIZE, n),
                        [4, (l = i.tidy((function() {
                            var t = a.capture(r);
                ...
                case 0:
                    return n = function(t) {
                        if ((t = t || {}).checkpointUrl && t.trainingLayer)
                            return (t.alpha || t.version) && console.warn("Checkpoint URL passed to modelOptions, alpha options are ignored"),
                            [t.checkpointUrl, t.trainingLayer];
                        if (t.version = t.version || 1,
                        1 === t.version) {
                            t.alpha = t.alpha || .25,
                            t.alpha = h(t.version, t.alpha),
                            console.log("Loading mobilenet " + t.version + " and alpha " + t.alpha);
                            var n = t.alpha.toFixed(2);
                            return "1.00" === n && (n = "1.0"),
                            ["https://storage.googleapis.com/tfjs-models/tfjs/mobilenet_v1_" + n + "_" + e.IMAGE_SIZE + "/model.json", "conv_pw_13_relu"]
                        }
                        if (2 === t.version)
                            return t.alpha = t.alpha || .35,
                            t.alpha = h(t.version, t.alpha),
                            console.log("Loading mobilenet " + t.version + " and alpha " + t.alpha),
                            ["https://storage.googleapis.com/teachable-machine-models/mobilenet_v2_weights_tf_dim_ordering_tf_kernels_" + t.alpha.toFixed(2) + "_" + e.IMAGE_SIZE + "_no_top/model.json", "out_relu"];
...
, function(t, e, n) {
    ...
    e.resizeMaxTo = function(t, e, n) {
        return void 0 === n && (n = r()),
        o(t, e / Math.max(t.width, t.height), n)
    }
    ,
    e.resizeMinTo = function(t, e, n) {
        return void 0 === n && (n = r()),
        o(t, e / Math.min(t.width, t.height), n)
    }
    ,
    e.cropTo = function(t, e, n, o) {
        void 0 === n && (n = !1),
        ...
        var i = t.width
          , s = t.height;
        t instanceof HTMLVideoElement && (i = t.videoWidth,
        s = t.videoHeight);
        ...
        return p.drawImage(t, -1 * ~~(u / 2), -1 * ~~(h / 2), c, l),
        n && (p.scale(-1, 1),
        p.drawImage(o, -1 * e, 0)),
        o
    }
    ...
    (function(e) {
        ...
        function b(t, e, n, r) {
            ...
            if (null !== t && "object" == typeof t || null !== e && "object" == typeof e) {
                if (h(t) && h(e) && u(t) === u(e) && !(t instanceof Float32Array || t instanceof Float64Array))
                ...
                return -1 !== a && a === r.expected.indexOf(e) || (r.actual.push(t),
                r.expected.push(e),
                function(t, e, n, r) {
                    if (null == t || null == e)
                        return !1;
        ...
        function x(t, e, n, r) {
            ...
            var i = "string" == typeof r
              , a = !t && o && !n;
            if ((!t && s.isError(o) && i && _(o, n) || a) && g(o, n, "Got unwanted exception" + r),
            t && o && n && !_(o, n) || !t && o)
                throw o
        }
    ...
    class c extends i.HTTPRequest {
        ...
        save(t) {
            return r(this, void 0, void 0, (function*() {
                ...
                e.body.append("metadata.json", new Blob([JSON.stringify(this.metadata)],{
                    type: "application/json"
                }), "metadata.json");
    ...
    var i = n(9)
      ...
      , u = function() {
        function t(t, e) {
            ...
            null != e.fetchFunc ? (s.assert("function" == typeof e.fetchFunc, (function() {
                return "Must pass a function that matches the signature of `fetch` (see https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API)"
            }
            )),
            this.fetch = e.fetchFunc) : this.fetch = i.env().platform.fetch,
            ...
            return r(this, void 0, void 0, (function() {
                ...
                return o(this, (function(o) {
                    ...
                    case 0:
                        ...
                        [4, l.loadWeightsAsArrayBuffer(f, {
                    ...
                    case 1:
                        return y = o.sent(),
                        [2, [c, a.concatenateArrayBuffers(y)]]
                    }
                }
                ))
            }
...
, function(t, e, n) {
    ...
    function l(t, e, n, l) {
        if (void 0 === l && (l = "numeric"),
        t instanceof i.Tensor)
            return c(l, t.dtype, e, n),
            t;
        var u = s.inferDtype(t);
        if ("string" !== u && ["bool", "int32", "float32"].indexOf(l) >= 0 && (u = l),
        c(l, u, e, n),
        null == t || !s.isTypedArray(t) && !Array.isArray(t) && "number" != typeof t && "boolean" != typeof t && "string" != typeof t) {
    ...
    e.op = function(t) {
        ...
        var i = function() {
            ...
            try {
                ...
                return i instanceof Promise && console.error("Cannot return a Promise inside of tidy."),
                r.ENGINE.endScope(i),
                i
            } catch (t) {
                throw r.ENGINE.endScope(null),
                t
            }
        };
    ...
    function u(t, e) {
        return r(this, void 0, void 0, (function() {
            ...
            return o(this, (function(o) {
                ...
                case 0:
                    return null == e && (e = {}),
                    n = null == e.fetchFunc ? i.env().platform.fetch : e.fetchFunc,
                    r = t.map((function(t) {
                        ...
                        n.forEach((function(t, n) {
                            ...
                            t.weights.forEach((function(t) {
                                var i = "quantization"in t ? t.quantization.dtype : t.dtype
                                  , a = l.DTYPE_VALUE_SIZE_MAP[i] * s.sizeFromShape(t.shape)
                                  , p = function() {
                                    e[n] = !0,
                                    null == r[n] && (r[n] = []),
                                    r[n].push({
                    ...
                    case 1:
                        ...
                        d.forEach((function(t) {
                            ...
                            r[t].forEach((function(t) {
                                var e = s.slice(t.groupOffset, t.groupOffset + t.sizeBytes)
...
, function(t, e, n) {
    ...
    let i = class extends o.LitElement {
        ...
        update(t) {
            return t.has("checked") && void 0 !== t.get("checked") && this.dispatchEvent(new CustomEvent("change",{
                bubbles: !0
            })),
            super.update(t)
        }
...
, function(t, e, n) {
    ...
    const i = n(53)
      ...
      , c = n(110)
      , l = n(8);
    e.barGraphPalette = [["#D84C6F", "#FFE9EC"], ["#794AEF", "#F1F0FF"], ["#1967D2", "#D2E3FC"], ["#E67701", "#FFECE2"]],
    e.defaultWizardSchema = {
        ...
        onReady: ()=>{}
        ,
        onPrediction: ()=>console.warn("Wizard onPrediction has not been added"),
        train: {
            title: "Train",
            description: "OK, let's train your model!"
        },
        type: "image"
    };
    class u {
        constructor(t) {
            ...
            n.forEach(e=>{
                var n, r;
                "object" == typeof this.schema[e] ? Object.assign(this.schema[e], t[e]) : null !== t[e] && void 0 !== t[e] && (n = this.schema,
                r = t[e],
                n[e] = r)
            }
            ),
            ...
            a(this.schema.classes.length > 1, "schema.classes must have at least 2 classes"),
            ...
            this.schema.introduction && (this.schema.introduction.title && (this.domElement.introduction.title = this.schema.introduction.title),
            this.schema.introduction.description && (this.domElement.introduction.description = this.schema.introduction.description)),
            this.schema.autoLoad && this.load().then(()=>t.onLoad && t.onLoad()),
            this.domElement.classes = this.schema.classes,
            t.onSampleAdded && this.domElement.addEventListener("sampleadd", e=>{
                const n = e.detail;
                t.onSampleAdded(n)
            }
            ),
            t.onTrain && this.domElement.addEventListener("train", ()=>t.onTrain()),
            t.onTrainComplete && this.domElement.addEventListener("traincomplete", ()=>t.onTrainComplete())
        }
        handleWizardOpen(t) {
            this.schema.onOpen()
        }
        handleWizardClose(t) {
            this.schema.onClose(),
            !this.isReady && this.domElement.isTrained && (this.isReady = !0,
            this.schema.onReady())
        }
        open() {
            this.domElement.parentElement || document.body.appendChild(this.domElement),
            this.domElement.open = !this.domElement.open
        }
        createInferenceCamera(t={}) {
            const e = Object.assign({
                deviceId: this.domElement.lastDeviceId
            }, u.defaultInferenceWebcamSettings, t)
            ...
            let r = !0;
            return n.classList.add("tm-inference-camera"),
            n.addEventListener("update", ()=>o(this, void 0, void 0, (function*() {
                if (!this.domElement.isTrained || this.domElement.open)
                    return;
...
, function(t, e, n) {
    ...
    let d = class extends i.LitElement {
        constructor() {
            ...
            this.introduction = {
                title: "Welcome to the teachablemachine.js training wizard",
        ...
        addSample(t, e) {
            return o(this, void 0, void 0, (function*() {
                this.samples[t] || (this.samples[t] = []),
                this.samples[t].push(e);
                const n = ()=>o(this, void 0, void 0, (function*() {
                    yield this.model.addExample(t, e),
                    this.__modelHasBeenTrained = !1,
                    this.dispatchEvent(new CustomEvent("sampleadd",{
                        detail: {
                            index: t,
                            name: this.classes[t],
                            sample: e
        ...
        train() {
            return o(this, void 0, void 0, (function*() {
                ...
                this.stepIndex++,
                console.log(`post stepIndex: ${this.stepIndex}, ${this.stepIndex - this.classes.length}`),
                this.requestUpdate()
            }
            ))
        }
        firstUpdated(t) {
            return this.nextButton = this.shadowRoot.querySelector("#next tm-button"),
        ...
        renderClassifierCard(t) {
            ...
            if (t < 0 || t > e.length)
                throw new Error(`Invalid Classifier card requested, class ${t} does not exist`);
            this.backButton.disabled = !1,
            this.canProgress = ()=>this.samples && this.samples[t] && this.samples[t].length >= Math.max(e[t].minimum || 0, 1);
            const n = ((t,e)=>{
                const n = Object.assign({}, t, e || {});
                if (n.frameRate = n.frameRate || 1 / 0,
            ...
            <div id="left-content">
                ...
                if (yield this.addSample(t, r),
                n.webcamElement && n.webcamElement.currentMediaStreamTrack) {
        ...
        renderTrainCard() {
            ...
            return this.canProgress = ()=>this.isTrained,
            i.html`
            <div id="left-content">
                ...
                console.log(`samples: ${this.samples.map((t,e)=>`[${e}] ${this.classes[e].name}: ${t.length}`)}`),
                yield this.train(),
                this.canProgress = ()=>!0,
                this.requestUpdate()
            }
        ...
        renderPublishCard() {
            ...
            <tm-button
                ...
                console.log(t);
                const e = (yield this.model.save(t)).responses[0]
                  , n = yield e.json();
                console.log("response", n),
                this.shadowRoot.querySelector("#waiting").innerHTML = `name: ${n.name}, token: ${n.token}`,
                p.addPublished(n)
            }
            ))}></tm-button>
        ...
        getPart() {
            ...
            return t.push(this.renderTrainCard, this.renderRunCard),
            t[this.stepIndex]()
        }
        render() {
            return i.html`
            ...
            <ta-card>
                ...
                this.stepIndex + 1 < this.totalSteps ? (this.stepIndex++,
                console.log("request update stepIndex", this.stepIndex),
                this.requestUpdate()) : this.open = !1
            }
            }></tm-button>
                    </div>
            </ta-card>
        ...
        updated(t) {
            return t.has("open") && this.dispatchEvent(new CustomEvent(this.open ? "open" : "close",{
                bubbles: !0
            })),
            super.updated(t)
        }
    ...
    r([i.property({
        type: Array
    })], d.prototype, "classes", void 0),
    r([i.property({
        type: Object
    })], d.prototype, "inputSettings", void 0),
    r([i.property({
        type: Object
    })], d.prototype, "training", void 0),
    r([i.property({
        type: Object
    })], d.prototype, "introduction", void 0),
...
, function(t, e, n) {
    ...
    r([o.property({
        type: Number
    })], s.prototype, "steps", void 0),
    r([o.property({
        type: Number
    })], s.prototype, "value", void 0),
    s = r([o.customElement("progress-bars")], s),
...
, function(t, e, n) {
    ...
    let a = class extends o.LitElement {
        ...
        connectedCallback() {
            return this.play && this.hasUpdated > 0 && this.loop.start(),
            super.connectedCallback()
        }
        disconnectedCallback() {
        ...
        firstUpdated(t) {
            return this.sampleContainer = this.shadowRoot.querySelector(".sample-preview-container"),
            this.play && this.loop.start(),
            super.firstUpdated(t)
        }
        updated(t) {
            return t.has("play") && this.loop[this.play ? "start" : "stop"](),
    ...
    r([o.property({
        type: Boolean,
        reflect: !0
    })], a.prototype, "play", void 0),
    r([o.property({
        type: Number
    })], a.prototype, "fps", void 0),
    r([o.property({
        type: Boolean,
        reflect: !0
    })], a.prototype, "showClassName", void 0),
    ...
    l.prototype.emit = function(t, e, n, r, i, s) {
        ...
        if (u.fn) {
            ...
            case 4:
                ...
                !0;
            case 5:
                return u.fn.call(u.context, e, n, r, i),
                !0;
            case 6:
                return u.fn.call(u.context, e, n, r, i, s),
                !0
            }
            for (l = 1,
    ...
    l.prototype.removeListener = function(t, e, n, r) {
        ...
        if (s.fn)
            ...
            for (var a = 0, l = [], u = s.length; a < u; a++)
                (s[a].fn !== e || r && !s[a].once || n && s[a].context !== n) && l.push(s[a]);
...
, function(t, e, n) {
    (function(e) {
        for (var r = n(60), o = "undefined" == typeof window ? e : window, i = ["moz", "webkit"], s = "AnimationFrame", a = o["request" + s], c = o["cancel" + s] || o["cancelRequest" + s], l = 0; !a && l < i.length; l++)
            a = o[i[l] + "Request" + s],
...
, function(t, e, n) {
    ...
    e.distance = (t,e)=>Math.sqrt(Math.pow(t[0] - e[0], 2) + Math.pow(t[1] - e[1], 2)),
    e.equal = (t,e)=>t[0] === e[0] && t[1] === e[1],
    e.lerp = function(t, e, n, r=[NaN, NaN]) {
        return r[0] = (e[0] - t[0]) * n + t[0],
        r[1] = (e[1] - t[1]) * n + t[1],
        r
    }
    ,
...
, function(t, e, n) {
    ...
    e.isTouchEvent = t=>t && "string" == typeof t.type && 0 === t.type.indexOf("touch") && !!t.touches;
    ...
    function o(t, e=!0, n=[0, 0]) {
        ...
        return e || (s.y = o.pageYOffset || a.scrollTop,
    ...
    e.mousePositionFromEvent = function(t, n, o, i) {
        let a, c;
        if (e.isTouchEvent(t) ? t.touches && t.touches[0] ? (a = t.touches[0].clientX,
        c = t.touches[0].clientY) : (a = NaN,
        c = NaN) : (a = t.clientX,
        c = t.clientY),
...
, function(t, e, n) {
    ...
    e.flipCoin = (t=.5)=>Math.random() > t,
    e.lerp = (t,e,n)=>n * (e - t) + t,
    e.interpolateArray = (t,e,n,o,i=[])=>r.fastMap(e, (e,r)=>{
        return t(e, n[r], (i = o,
        Array.isArray(i) || (t=>!!t.length && "number" == typeof t.BYTES_PER_ELEMENT && "number" == typeof t.byteLength)(i) ? o[r] : o));
        var i
    }
    , i),
    e.lerpArray = (t,n,r,o=[])=>e.interpolateArray(e.lerp, t, n, r, o),
    ...
    ,
    e.toPrecision = (t,e=.001)=>Math.floor(t / e) * e,
...
, function(t, e, n) {
    ...
    e.defaultSampleProcessor = (t,e,n,r)=>o(void 0, void 0, void 0, (function*() {
        if (!a.isCanvasImageSource(e))
            throw new Error("Default Processor requires `sample` to be HTMLCanvasElement");
    ...
    class l extends s.LitElement {
        ...
        addSample(t) {
            for (i.util.assert(null != t.sample, ()=>"received an empty or invalid sample"),
            i.util.assert(null != t.displaySample, ()=>"received an invalid displaySample"),
            this._samples.push(t.sample),
            this._displaySamples.push(t.displaySample),
            this._sampleUIDs.push(t.uid); this._samples.length > this.maxSamples; )
                this._samples.shift();
        ...
        updated(t) {
            return t.has("stats") && (this.stats ? (this._statsElement = this._statsElement || document.createElement("tm-stats"),
            this._statsElement.now(),
            this._statsElement.now(),
            this.shadowRoot.appendChild(this._statsElement),
            this._statsElement.mapStats = t=>`${t.fps} fps, ${this.samples.length} / ${this.maxSamples} samples`) : this._statsElement && (this._statsElement.parentNode && this._statsElement.parentNode.removeChild(this._statsElement),
    ...
    r([s.property({
        type: Boolean,
        reflect: !0
    })], l.prototype, "stats", void 0),
    r([s.property({
        type: String
    })], l.prototype, "label", void 0),
    r([s.property({
        type: String
    })], l.prototype, "buttonLabel", void 0),
    r([s.property({
        type: String
    })], l.prototype, "buttonSVG", void 0),
    r([s.property({
        type: Boolean,
        reflect: !0
    ...
    r([s.property({
        type: Number
    })], l.prototype, "sampleSize", void 0),
    r([s.property({
        type: Boolean
    })], l.prototype, "runSample", void 0),
    r([s.property({
        type: Boolean
    })], l.prototype, "skipDisplaySample", void 0),
    r([s.property({
        type: Number
    })], l.prototype, "maxSamples", void 0),
    r([s.property({
        type: Boolean
    })], l.prototype, "samplesArePlayable", void 0),
    ...
    t.exports = function() {
        function t(t) {
            ...
            return {
                ...
                toUUID: function(t) {
                    return function(t, e) {
                        for (var n, r = e(t), o = "", i = 0, s = 32 - r.length; i < s; ++i)
                            o += "0";
...
, function(t, e, n) {
    ...
    r.prototype.convert = function(t) {
        ...
        if (this.srcAlphabet === this.dstAlphabet)
            return t;
        for (e = 0; e < a; e++)
            o[e] = this.srcAlphabet.indexOf(t[e]);
        do {
            for (n = 0,
            r = 0,
            e = 0; e < a; e++)
                (n = n * i + o[e]) >= s ? (o[r++] = parseInt(n / s, 10),
                n %= s) : r > 0 && (o[r++] = 0);
            a = r,
            c = this.dstAlphabet.slice(n, n + 1).concat(c)
        } while (0 !== r);
        return c
    }
    ,
    r.prototype.isValid = function(t) {
        for (var e = 0; e < t.length; ++e)
            if (-1 === this.srcAlphabet.indexOf(t[e]))
                return !1;
        return !0
    }
    ,
...
, function(t, e, n) {
    ...
    class c extends i.LitElement {
        ...
        refreshDevices() {
            return o(this, void 0, void 0, (function*() {
                ...
                return t.length > 1 && "audioinput" === this.kind && t[0].groupId === t[1].groupId && t.shift(),
                t
            }
            ))
        }
    ...
    r([i.property({
        type: String
    })], c.prototype, "kind", void 0),
    r([i.property({
        type: Boolean
    })], c.prototype, "hideWhenEmpty", void 0),
...
, function(t, e, n) {
    ...
    function p(t, e) {
        for (var n, r = t.length, o = t.slice(), i = r - 1; i > 0; i -= 1) {
            var s = void 0;
            n = [o[s = e ? Math.floor(e() * (i + 1)) : Math.floor(Math.random() * (i + 1))], o[i]],
            o[i] = n[0],
            o[s] = n[1]
        }
        return o
    ...
    var d = function(t) {
        ...
        e.prototype.addExample = function(t, e) {
            return i(this, void 0, void 0, (function() {
                ...
                return s(this, (function(i) {
                    var s;
                    return n = "object" == typeof (s = e).dataId && "object" === s.shape ? e : l.capture(e),
        ...
        e.prototype.convertToTfDataset = function() {
            ...
            var e = []
              ...
              , r = function(t) {
                ...
                s), c = o.examples[t].length, l = c - Math.ceil(.15 * c), u = o.examples[t].slice(0, l).map((function(t) {
                    return {
                        data: t,
                        label: a
                    }
              ...
              , o = this;
            for (t = 0; t < this.examples.length; t++)
                r(t);
            e = p(e, this.seed),
            n = p(n, this.seed);
                ...
                return s(this, (function(s) {
                    ...
                    case 0:
                        ...
                        e.onTrainEnd = function(t) {
                            f.__stopTrainingResolve && (f.__stopTrainingResolve(),
                        ...
                        l = this.seed ? a.initializers.varianceScaling({
                            seed: 3.14
                        }) : a.initializers.varianceScaling({}),
                        this.trainingModel = a.sequential({
                            layers: [a.layers.dense({
                                inputShape: [i],
                                units: t.denseUnits,
                                activation: "relu",
                                kernelInitializer: l,
                        ...
                        return h = this.trainDataset.batch(t.batchSize),
                        p = this.validationDataset.batch(t.batchSize),
                        [4, this.trainingModel.fitDataset(h, {
                            epochs: t.epochs,
                            validationData: p,
                            callbacks: e
                        })];
        ...
        e.prototype.prepareDataset = function() {
            for (var t = 0; t < this.numClasses; t++)
                this.examples[t] = []
        }
        ,
        ...
        e.prototype.stopTraining = function() {
            ...
            return new Promise((function(e, n) {
                t.trainingModel.stopTraining = !0,
                t.__stopTrainingResolve = e
            }
            ))
        }
        ,
        ...
        !function(t, o, i) {
            function s(t) {
                ...
                function(t, e) {
                    ...
                    for (o >= 128 && (a[127 & (e && e.length || 0)] = -1),
                    o = 127,
                    i = 512; i > 0; --i)
                        r = a[o + 34 & 127],
                        n = a[o = o + 1 & 127],
...
, function(t, e, n) {
    ...
    !function(o, i) {
        var s, a = (0,
        eval)("this"), c = i.pow(256, 6), l = i.pow(2, 52), u = 2 * l;
        function h(t, e, n) {
            var r = []
              , h = f(function t(e, n) {
                var r, o = [], i = typeof e;
                ...
                try {
                    var t;
                    return s && (t = s.randomBytes) ? t = t(256) : (t = new Uint8Array(256),
        ...
        function p(t) {
            ...
            for (n || (t = [n++]); o < 256; )
                s[o] = o++;
            for (o = 0; o < 256; o++)
                s[o] = s[i = 255 & i + t[o % n] + (e = s[o])],
                s[i] = e;
            (r.g = function(t) {
                for (var e, n = 0, o = r.i, i = r.j, s = r.S; t--; )
                    e = s[o = 255 & o + 1],
                    n = 256 * n + s[255 & (s[o] = s[i = 255 & i + e]) + (s[i] = e)];
                return r.i = o,
                r.j = i,
                n
            }
    ...
    var s = n(8)
      ...
      , l = function() {
        ...
        return t.prototype.getWebcam = function(t) {
            ...
            t.width = 640;
            var e = function(t) {
                return t.facingMode = t.facingMode || c.facingMode,
...
, function(t, e, n) {
    (function(t) {
        ...
        function u(t, n, r) {
            ...
            (d(n) && (E = !0,
            T = ["[", "]"]),
            S(n)) && (w = " [Function" + (n.name ? ": " + n.name : "") + "]");
            return b(n) && (w = " " + RegExp.prototype.toString.call(n)),
            _(n) && (w = " " + Date.prototype.toUTCString.call(n)),
            x(n) && (w = " " + h(n)),
            0 !== s.length || E && 0 != n.length ? r < 0 ? b(n) ? t.stylize(RegExp.prototype.toString.call(n), "regexp") : t.stylize("[Object]", "special") : (t.seen.push(n),
            l = E ? function(t, e, n, r, o) {
                for (var i = [], s = 0, a = e.length; s < a; ++s)
                    A(e, String(s)) ? i.push(p(t, e, n, r, String(s), !0)) : i.push("");
        ...
        function p(t, e, n, r, o, i) {
            ...
            if ((c = Object.getOwnPropertyDescriptor(e, o) || {
                value: e[o]
            }).get ? a = c.set ? t.stylize("[Getter/Setter]", "special") : t.stylize("[Getter]", "special") : c.set && (a = t.stylize("[Setter]", "special")),
            A(r, o) || (s = "[" + o + "]"),
            a || (t.seen.indexOf(c.value) < 0 ? (a = y(n) ? u(t, c.value, null) : u(t, c.value, n - 1)).indexOf("\n") > -1 && (a = i ? a.split("\n").map((function(t) {
                return "  " + t
            }
            )).join("\n").substr(2) : "\n" + a.split("\n").map((function(t) {
                return "   " + t
...
, function(t, e, n) {
    ...
    (function(t) {
        ...
        function g(t, e, n, r, o) {
            ...
            if ("number" == typeof e)
                return e &= 255,
                c.TYPED_ARRAY_SUPPORT && "function" == typeof Uint8Array.prototype.indexOf ? o ? Uint8Array.prototype.indexOf.call(t, e, n) : Uint8Array.prototype.lastIndexOf.call(t, e, n) : v(t, [e], n, r, o);
        ...
        c.prototype.compare = function(t, e, n, r, o) {
            ...
            if (this === t)
                return 0;
            for (var i = (o >>>= 0) - (r >>>= 0), s = (n >>>= 0) - (e >>>= 0), a = Math.min(i, s), l = this.slice(r, o), u = t.slice(e, n), h = 0; h < a; ++h)
                if (l[h] !== u[h]) {
                    i = l[h],
                    s = u[h];
                    break
...
, function(t, e) {
    ...
    e.write = function(t, e, n, r, o, i) {
        ...
        c *= 2),
        (e += s + h >= 1 ? p / c : p * Math.pow(2, 1 - h)) * c >= 2 && (s++,
        c /= 2),
        s + h >= u ? (a = 0,
        s = u) : s + h >= 1 ? (a = (e * c - 1) * Math.pow(2, o),
...
, function(t, e, n) {
    ...
    var r = n(23)
      ...
      , c = n(46);
    function l(t, e, n, i) {
        if (null == i && (i = s.inferDtype(t)),
        "complex64" === i)
            throw new Error("Cannot construct a complex64 tensor directly. Please use tf.complex(real, imag).");
        if (!s.isTypedArray(t) && !Array.isArray(t) && "number" != typeof t && "boolean" != typeof t && "string" != typeof t)
        ...
        return s.isTypedArray(t) || Array.isArray(t) || (t = [t]),
        e = e || n,
        t = "string" !== i ? s.toTypedArray(t, i, o.env().getBool("DEBUG")) : s.flatten(t, [], !0),
    ...
    e.scalar = function(t, e) {
        if ((s.isTypedArray(t) && "string" !== e || Array.isArray(t)) && "complex64" !== e)
    ...
    e.variable = function(t, e, n, o) {
        return void 0 === e && (e = !0),
        r.ENGINE.makeVariable(t, e, n, o)
    }
    ,
    e.ones = function t(e, n) {
        if (void 0 === n && (n = "float32"),
        "complex64" === n) {
            var o = t(e, "float32")
              , i = h(e, "float32");
...
, function(t, e, n) {
    ...
    e.registerKernel = function(t) {
        var e = t.kernelName
          ...
          , i = o(e, n);
        if (r.has(i))
            throw new Error("The kernel '" + e + "' for backend '" + n + "' is already registered");
        r.set(i, t)
    }
    ,
        ...
        return t.prototype.profileKernel = function(t, e, n) {
            ...
            return r.forEach((function(n) {
                n.data().then((function(r) {
                    ...
                    s.then((function(i) {
                        var s = "";
                        null != i.getExtraProfileInfo && (s = i.getExtraProfileInfo()),
...
, function(t, e, n) {
    ...
    e.backpropagateGradients = function(t, e, n) {
        for (var o = function(o) {
            ...
            null == i.gradient)
                throw new Error("Cannot compute gradient: gradient function not found for " + i.name + ".");
            var a = i.gradient(s)
              , c = function(e) {
                if (!(e in a))
                    throw new Error("Cannot backprop through input " + e + ". Available gradients found: " + Object.keys(a) + ".");
                var o = n((function() {
                    return a[e]()
                }
                ));
                if ("float32" !== o.dtype)
                    throw new Error("Error in gradient for op " + i.name + ". The gradient of input " + e + " must have 'float32' dtype, but has '" + o.dtype + "'");
                var s = i.inputs[e];
                if (!r.arraysEqual(o.shape, s.shape))
                    throw new Error("Error in gradient for op " + i.name + ". The gradient of input '" + e + "' has shape '" + o.shape + "', which does not match the shape of the input '" + s.shape + "'");
                if (null == t[s.id])
                    t[s.id] = o;
                else {
                    var c = t[s.id];
...
, function(t, e, n) {
    ...
    function o(t, e, n) {
        var o;
        return o = Array.isArray(t) ? parseFloat(t[0].toFixed(7)) + " + " + parseFloat(t[1].toFixed(7)) + "j" : r.isString(t) ? "'" + t + "'" : "bool" === n ? i(t) : parseFloat(t.toFixed(7)).toString(),
        r.rightPad(o, e)
    }
    function i(t) {
    ...
    e.tensorToString = function(t, e, n, a) {
        var c = r.computeStrides(e)
          ...
          , h = function t(e, n, r, a, c, l) {
            ...
            var S = 2 === p ? "," : "";
            b[0] = "[" + b[0] + S;
            for (w = 1; w < b.length - 1; w++)
                b[w] = " " + b[w] + S;
            var E = ",\n";
            for (w = 2; w < p; w++)
                E += "\n";
            return b[b.length - 1] = " " + b[b.length - 1] + "]" + (l ? "" : E),
            b
        }(t, e, n, c, l)
          , p = ["Tensor"];
        return a && (p.push("  dtype: " + n),
        p.push("  rank: " + u),
        p.push("  shape: [" + e + "]"),
        p.push("  values:")),
        p.push(h.map((function(t) {
            return "    " + t
        }
        )).join("\n")),
        p.join("\n")
...
, function(t, e, n) {
    ...
    e.complex = s.op({
        complex_: function(t, e) {
            ...
            return i.assertShapesMatch(n.shape, s.shape, "real and imag shapes, " + n.shape + " and " + s.shape + ", must match in call to tf.complex()."),
            r.ENGINE.runKernelFunc((function(t) {
...
, function(t, e, n) {
    ...
    var s = n(106);
    e.fromMemory = s.fromMemory,
    e.withSaveHandler = s.withSaveHandler;
    var a = n(20);
...
, function(t, e, n) {
            ...
            return new Promise((function(t, r) {
                ...
                o.onsuccess = function() {
                    ...
                    if (null == e) {
                        ...
                        var l, u = s.getModelArtifactsInfoForJSON(e), h = i.transaction("model_info_store", "readwrite"), p = h.objectStore("model_info_store"), d = p.put({
                            modelPath: n.modelPath,
                            modelArtifactsInfo: u
                        });
                        d.onsuccess = function() {
                            var o = (l = i.transaction("models_store", "readwrite")).objectStore("models_store").put({
                                modelPath: n.modelPath,
                                modelArtifacts: e,
                                modelArtifactsInfo: u
                            });
    ...
    var d = function() {
        ...
        t.prototype.removeModel = function(t) {
            return r(this, void 0, void 0, (function() {
                ...
                return o(this, (function(n) {
                    var r;
                    return t = (r = t).startsWith(h.URL_SCHEME) ? r.slice(h.URL_SCHEME.length) : r,
    ...
    if (e.BrowserIndexedDBManager = d,
    i.env().getBool("IS_BROWSER"))
        try {
...
, function(t, e, n) {
            ...
            return r(this, void 0, void 0, (function() {
                ...
                return o(this, (function(o) {
                    ...
                    try {
                        ...
                        this.LS.setItem(this.keys.weightData, a.arrayBufferToBase64String(t.weightData)),
    ...
    var w = function() {
            ...
            return r(this, void 0, void 0, (function() {
                ...
                return o(this, (function(o) {
                    ...
                    r = 0; r < this.LS.length; ++r)
                        (i = this.LS.key(r)).startsWith(e) && i.endsWith(n) && (s = g(i),
        ...
        t.prototype.removeModel = function(t) {
            return r(this, void 0, void 0, (function() {
                ...
                return o(this, (function(r) {
                    var o;
                    if (t = (o = t).startsWith(v.URL_SCHEME) ? o.slice(v.URL_SCHEME.length) : o,
                    e = m(t),
    ...
    if (e.BrowserLocalStorageManager = w,
    i.env().getBool("IS_BROWSER"))
        try {
        ...
        return t.prototype.save = function(t) {
            return r(this, void 0, void 0, (function() {
                ...
                return o(this, (function(o) {
                    ...
                    case 2:
                        return o.sent(),
                        null == t.weightData ? [3, 4] : ((l = null == this.weightDataAnchor ? document.createElement("a") : this.weightDataAnchor).download = this.weightDataFileName,
                        l.href = e,
                        [4, c((function() {
                                        ...
                                        t.paths.forEach((function(t) {
                                            ...
                                            e.onload = function(e) {
                                                ...
                                                -1 === d.indexOf(null) && r({
                                                    modelTopology: c,
                                                    weightSpecs: h,
                                                    weightData: s.concatenateArrayBuffers(d)
                                                })
                                            }
                                            ,
...
, function(t, e, n) {
    ...
    e.fromMemory = function(t, e, n, r) {
        if (1 === arguments.length) {
            ...
            return o ? new i(t) : (console.warn("Please call tf.io.fromMemory() with only one argument. The argument should be of type ModelArtifacts. The multi-argument signature of tf.io.fromMemory() has been deprecated and will be removed in a future release."),
            new i({
                modelTopology: t
            }))
        }
...
, function(t, e, n) {
    ...
    e.config = {
        PUBLISH_URL: "https://us-central1-gweb-teachable-ai.cloudfunctions.net/publish-release-2-1-2/publish"
    }
}
, function(t, e, n) {
    "use strict";
...
, function(t, e, n) {
    ...
    e.WebcamImageApp = class {
        ...
        bindToWebcamForClass(t, e, n, r={}) {
            ...
            -1 === this.labels.indexOf(n) && (this.labels.push(n),
            this.teachable.setLabels(this.labels),
            this._hasTrained = !1);
            const i = t=>{
            ...
            ;
            return o.addEventListener("mousedown", s),
        ...
        createTrainButton(t={}) {
            ...
            const n = t.onEpochEnd
              , o = t.trainParameters && t.trainParameters.epochs ? t.trainParameters.epochs : 50
              , s = {
                onTrainBegin: t.onTrainBegin,
                onTrainEnd: t.onTrainEnd,
                onEpochBegin: t.onEpochBegin,
                onEpochEnd: (t,i)=>r(this, void 0, void 0, (function*() {
                    e.value = t / o,
                    n && (yield n(t, i))
                }
                )),
        ...
        createWebcam(t={}, e) {
            ...
            return n.classList.add("tm-webcam"),
            n.open = !0,
            n.autoPlay = !0,
            n.showRecord = !0,
            e && n.addEventListener("sample", ()=>r(this, void 0, void 0, (function*() {
        ...
        addExample(t, e) {
            if (!this.teachable)
                throw new Error("Attempted to add an example but model is not loaded, be sure to call load() first");
            const n = this.labels.indexOf(t);
            if (-1 === n)
                throw new Error(`Class ${t} does not exist in labels`);
            this.teachable.addExample(n, e),
            this._hasTrained = !1
        }
        getExamples(t) {
        ...
        train(t={}, e={}) {
            return r(this, void 0, void 0, (function*() {
                if (t.denseUnits = t.denseUnits || 100,
                t.epochs = t.epochs || 50,
                t.learningRate = t.learningRate || 1e-4,
                t.batchSize = t.batchSize || 16,
                !this.teachable)
                    throw new Error("Attempted to add an example but model is not loaded, be sure to call load() first");
                yield this.teachable.train(t, e),
                this._hasTrained = !0
            }
            ))
        }
